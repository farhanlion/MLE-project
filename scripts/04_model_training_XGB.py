...
# coding: utf-8
"""
Train XGBoost only. Uses preprocessing_before_fit.prepare_data_for_training(...)
"""
...
if __name__ == "__main__":
    ...
    xgb_base = XGBClassifier(scale_pos_weight=data["scale_pos_weight"], random_state=args.random_state,
